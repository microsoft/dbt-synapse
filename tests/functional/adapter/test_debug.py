...
class TestDebugSynapse(BaseDebug):
    ...
    def test_connection_flag(self, project):
        """Testing the --connection flag works as expected, including that output is not lost"""
...
class TestDebugProfileVariableSynapse(BaseDebugProfileVariable):
    pass


class TestDebugInvalidProjectSynapse(BaseDebug):
