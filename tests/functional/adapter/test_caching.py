...
class TestCachingLowerCaseModelSynapse(BaseCachingLowercaseModel):
    pass


@pytest.mark.skip(reason="Synapse DW does not support Case Insensivity.")
class TestCachingUppercaseModelSynapse(BaseCachingUppercaseModel):
    pass


class TestCachingSelectedSchemaOnlySynapse(BaseCachingSelectedSchemaOnly):
    pass
