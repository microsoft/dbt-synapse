...
AZURE_AUTH_FUNCTIONS: Mapping[str, AZURE_AUTH_FUNCTION_TYPE] = {
    "ServicePrincipal": sqlserverconn.get_sp_access_token,
    "CLI": sqlserverconn.get_cli_access_token,
}
        ...
        try:
            ...
            if type_auth in AZURE_AUTH_FUNCTIONS.keys():
                ...
                if cls.TOKEN is None:
                    ...
                    cls.TOKEN = sqlserverconn.convert_access_token_to_mswindows_byte_string(
                        token
                    )
